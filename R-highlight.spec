...
Version  : 0.5.1
Release  : 45
URL      : https://cran.r-project.org/src/contrib/highlight_0.5.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/highlight_0.5.1.tar.gz
...
%setup -q -n highlight
pushd ..
cp -a highlight buildavx2
popd
pushd ..
cp -a highlight buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737147149
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/highlight/libs/highlight.so
/V4/usr/lib64/R/library/highlight/libs/highlight.so
